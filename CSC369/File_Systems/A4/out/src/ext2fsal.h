...
extern pthread_mutex_t group_desc_mutex;
extern pthread_mutex_t block_bitmap_mutex;
extern pthread_mutex_t inode_bitmap_mutex;
extern pthread_mutex_t inode_mutex[INODE_COUNT]; // Inode 1 has mutex 0, inode 0 does not need a mutex as it is reserved as invalid
