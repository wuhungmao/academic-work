...
void quit(char *toClient, int *fdlist, int i, char *user_lst[], message_queue_lst *client_mess_lst) {
...
int main (int argc, char ** argv) {
	...
	*/
	...
	/*ideas*/
		...
		This program will read, then process, then write to client.
		*/
						...
						/*recvMessage(fdlist[i], fromClient) */
							...
							if(retVal==1){
								...
								if(numParts==0){
									...
									quit(toClient, fdlist, i, user_lst, client_mess_lst);
