...
\item[] Course Research, University of Toronto Mississauga \hfill Apr 2026
 \begin{itemize}
 \item[] \textbf{Wu, H.-M.}, Bi, F., Abdelhadi, Y., Lin, W., Khan, L. \href{https://arxiv.org/abs/2607.06872} {Ensemble Deep Learning Approaches for AI-Altered Video Detection}. Computer Science Implementation Project (CSC492). arXiv:2607.06872.
    \vspace{3px}
...
\item[] \textbf{AI-Video Detection Ensemble} $\mid$ \textit{Python, PyTorch, OpenCV, NumPy} \hfill \href{https://github.com/utmgdsc/AI-Video-Detection}{Link} $\mid$ Feb 2026
  \begin{itemize}
    ...
    \item Co-authored the research manuscript {``Ensemble Deep Learning Approaches for AI-Altered Video Detection,''} published on arXiv (\href{https://arxiv.org/abs/2607.06872}{arXiv:2607.06872}), detailing the multimodal architecture, performance metrics, and ensemble strategies.
