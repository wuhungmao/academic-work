...
\item[] \textbf{AI-Video Detection Ensemble} $\mid$ \textit{Python, PyTorch, React, Modal, Vercel} \hfill \href{https://github.com/utmgdsc/AI-Video-Detection}{GitHub} $\mid$ \href{https://deepfake-detector-gamma.vercel.app/}{Live Demo} $\mid$ Feb 2026
  \begin{itemize}
    \item \textbf{Deployed} a full-stack deepfake detection web app: React frontend on Vercel and serverless GPU inference backend on Modal, accessible at \href{https://deepfake-detector-gamma.vercel.app/}{deepfake-detector-gamma.vercel.app}.
