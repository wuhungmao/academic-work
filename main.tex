...
\begin{itemize}
  \item[] \textbf{Decidophobia.com} $\mid$ \textit{Django, React, JavaScript, HTML/CSS, SQL} \hfill Jan 2024 - Apr 2024
  \begin{itemize}
  ...
  \item[] \textbf{Wordle Game} $\mid$ \textit{Node.js, Express.js, jQuery} \hfill \href{}{Link} $\mid$ Mar 2024
  \begin{itemize}
  ...
  \item[] \textbf{Database Join with OpenMP and MPI} $\mid$ \textit{C} \hfill \href{https://github.com/wuhungmao/academic-work/tree/main/CSC367/Database\%20join\%20with\%20openMP\%20and\%20MPI}{Link} $\mid$ Oct 2023 - Nov 2023
  \begin{itemize}
    ...
    \item Utilized C along with parallel programming concepts.
  \end{itemize}
  \vspace{3px}
  ...
  \begin{itemize}
    ...
    \item Employed Java to interact with an SQLite database, leveraging JSON-formatted messages. Utilized generative AI to enhance productivity.
  \end{itemize}
  \vspace{3px}

  \item[] \textbf{File System Simulation} $\mid$ \textit{C} \hfill \href{https://github.com/wuhungmao/academic-work/tree/main/CSC369/File_Systems}{Link} $\mid$ Sep 2025 - Dec 2025
  \begin{itemize}
  ...
  \item[] \textbf{Boggle Game} $\mid$ \textit{Java, JavaFX} \hfill \href{https://github.com/wuhungmao/academic-work/tree/95369cac8bbce77f4c321954c4afb07f3d207d28/csc\%20207\%20Group\%20Project}{Link} $\mid$ Oct 2022 - Dec 2022
  \begin{itemize}
  ...
  \item[] \textbf{Pacman Game} $\mid$ \textit{Python} \hfill \href{https://github.com/wuhungmao/academic-work/tree/main/CSC384/Pacman\%20project/search}{Link} $\mid$ Sep 2023 - Oct 2023
  \begin{itemize}
    \item Implemented a Pacman game utilizing search algorithms like DFS, BFS, A*, etc., achieving a score of 80.
  \end{itemize}
  \vspace{3px}

  \item[] \textbf{Personal Website} $\mid$ \textit{HTML, CSS, JavaScript} \hfill \href{https://github.com/wuhungmao/academic-work/tree/main/Personal\%20website}{Link} $\mid$ Dec 2023 - Jan 2024
  \begin{itemize}
    \item Developed a website showcasing my hobbies, course reflections, and school projects.
    \item Independently learned HTML, CSS, and JavaScript to craft a responsive website.
  \end{itemize}
  \vspace{3px}

  \item[] \textbf{Ethernet Frame and ARP Request} $\mid$ \textit{C++} \hfill \href{https://github.com/wuhungmao/academic-work/tree/main/CSC358/pa1_starter_code}{Link} $\mid$ Feb 2024
  \begin{itemize}
    \item Demonstrated understanding and application of concepts related to Ethernet frames and ARP requests.
    \item Used C++ to simulate how switches handle Ethernet frames.
  \end{itemize}
\end{itemize}
