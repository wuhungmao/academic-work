...
private:
  ...
  std::unordered_map<uint32_t, size_t> cache_time_table;
  std::unordered_map<uint32_t, size_t> arp_time_table;
  std::vector<std::pair<InternetDatagram, Address>> waiting_queue;
  std::queue<EthernetFrame> ready_queue;
